...
Restrictions |[associatedFunction](associatedFunction) (op) **only** [Function](Function) (c)<br />[qualifiedAssociation](qualifiedAssociation) (op) **some** [Association](Association) (c)<br />[hasLocation](hasLocation) (op) **only** [SpatialLocation](SpatialLocation) (c)<br />[startedAtTime](startedAtTime) (dp) **max** 1<br />[requiresSecurityClassification](requiresSecurityClassification) (op) **only** [SecurityClassification](SecurityClassification) (c)<br />[guidingPolicy](guidingPolicy) (op) **only** [Policy](Policy) (c)<br />[wasAssociatedWith](wasAssociatedWith) (op) **some** [Agent](Agent) (c)<br />[usedRecord](usedRecord) (op) **only** [Record](Record) (c)<br />[endedAtTime](endedAtTime) (dp) **max** 1<br />[hasStatus](hasStatus) (op) **only** [Status](Status) (c)<br />
...
Restrictions |[hasQuality](hasQuality) (op) **some** [PreservationQuality](PreservationQuality) (c)<br />[isAffectedBy](isAffectedBy) (op) **some** [Event](Event) (c)<br />[relatedTo](relatedTo) (op) **only** [Artefact](Artefact) (c)<br />[storedIn](storedIn) (op) **some** [IntellectualControlSystem](IntellectualControlSystem) (c)<br />[isChangedBy](isChangedBy) (op) **some** [InformationSystem](InformationSystem) (c)<br />[hasLocation](hasLocation) (op) **only** [SpatialLocation](SpatialLocation) (c)<br />[softwareAssignedID](softwareAssignedID) (dp) **some** [xsd:string](http://www.w3.org/2001/XMLSchema#string) (c)<br />[requiresSecurityClassification](requiresSecurityClassification) (op) **only** [SecurityClassification](SecurityClassification) (c)<br />
...
Sub-classes |[JurisdictionalCoverage](JurisdictionalCoverage) (c)<br />[TemporalCoverage](TemporalCoverage) (c)<br />[SpatialCoverage](SpatialCoverage) (c)<br />
...
Restrictions |[affects](affects) (op) **some** ([Artefact](Artefact) (c) or [Record](Record) (c))<br />[triggeredBy](triggeredBy) (op) **only** [Trigger](Trigger) (c)<br />[associatedFunction](associatedFunction) (op) **only** [Function](Function) (c)<br />[wasAssociatedWith](wasAssociatedWith) (op) **some** [Agent](Agent) (c)<br />[hasStatus](hasStatus) (op) **only** [Status](Status) (c)<br />[qualifiedAssociation](qualifiedAssociation) (op) **some** [Association](Association) (c)<br />[guidingPolicy](guidingPolicy) (op) **only** [Policy](Policy) (c)<br />[priorEvent](priorEvent) (op) **only** [Event](Event) (c)<br />
Sub-classes |[ArtefactChangeEvent](ArtefactChangeEvent) (c)<br />[RecordControlEvent](RecordControlEvent) (c)<br />[CreationEvent](RecordCreationEvent) (c)<br />[ArtefactControlEvent](ArtefactControlEvent) (c)<br />
### Form Factor
Property | Value
--- | ---
...
Sub-classes |[InformationManagementPolicy](InformationManagementPolicy) (c)<br />[RecordsAuthorityPolicy](RecordsAuthorityDisposalClassPolicy) (c)<br />[DigitalPreservationPolicy](DigitalPreservationPolicy) (c)<br />[MinimumMetadataSetPolicy](MinimumMetadataSetPolicy) (c)<br />[RecordStorageStandard](RecordStorageStandard) (c)<br />
...
Restrictions |[recordOf](recordOf) (op) **min** 1 [Artefact](Artefact) (c)<br />[isAffectedBy](isAffectedBy) (op) **exactly** 1 [CreationEvent](RecordCreationEvent) (c)<br />[hasActivity](hasActivity) (op) **only** [Activity](Activity) (c)<br />[hasClassifier](hasClassifier) (op) **some** [Classifier](Classifier) (c)<br />[hasSeries](hasSeries) (op) **only** [Series](Series) (c)<br />[hasStatus](hasStatus) (op) **only** [Status](Status) (c)<br />[hasDisposalClass](hasDisposalClass) (op) **exactly** 1 [DisposalClass](DisposalClass) (c)<br />[replaces](replaces) (op) **only** [Record](Record) (c)<br />[checksum](checksum) (dp) **max** 1<br />[qualifiedAssociation](qualifiedAssociation) (op) **some** [Association](Association) (c)<br />[hasCoverage](hasCoverage) (op) **only** [Coverage](Coverage) (c)<br />[relatedTo](relatedTo) (op) **only** [Record](Record) (c)<br />[associatedFunction](associatedFunction) (op) **min** 1 [Function](Function) (c)<br />[isAffectedBy](isAffectedBy) (op) **only** [Event](Event) (c)<br />[hasControl](requiresControl) (op) **only** [Control](Control) (c)<br />[requiresSecurityClassification](requiresSecurityClassification) (op) **only** [SecurityClassification](SecurityClassification) (c)<br />
### Record Audit Event
Property | Value
--- | ---
...
Super-classes |[Event](Event) (c)<br />
Restrictions |[hasControl](requiresControl) (op) **only** [Control](Control) (c)<br />
Sub-classes |[RecordReplacementEvent](RecordReplacementEvent) (c)<br />[RecordSentencingEvent](RecordSentencingEvent) (c)<br />[RecordDisposalEvent](RecordDisposalEvent) (c)<br />[RecordAuditEvent](RecordAuditEvent) (c)<br />[RecordDecisionEvent](RecordDecisionEvent) (c)<br />
...
Super-classes |[RecordDisposalEvent](RecordDisposalEvent) (c)<br />
Restrictions |[hasManifest](hasManifest) (op) **only** [Manifest](Manifest) (c)<br />[transferredFrom](transferredFrom) (op) **some** [Role](Role) (c)<br />[transferredTo](transferredTo) (op) **some** [Role](Role) (c)<br />
