...
Restrictions |[qualifiedAssociation](qualifiedAssociation) (op) **some** [Association](Association) (c)<br />[guidingPolicy](guidingPolicy) (op) **only** [Policy](Policy) (c)<br />[startedAtTime](startedAtTime) (dp) **max** 1<br />[wasAssociatedWith](wasAssociatedWith) (op) **some** [Agent](Agent) (c)<br />[associatedFunction](associatedFunction) (op) **only** [Function](Function) (c)<br />[requiresSecurityClassification](requiresSecurityClassification) (op) **only** [SecurityClassification](SecurityClassification) (c)<br />[endedAtTime](endedAtTime) (dp) **max** 1<br />[hasStatus](hasStatus) (op) **only** [Status](Status) (c)<br />[usedRecord](usedRecord) (op) **only** [Record](Record) (c)<br />[hasLocation](hasLocation) (op) **only** [SpatialLocation](SpatialLocation) (c)<br />
...
Restrictions |[positionIn](positionIn) (op) **some** [Organisation](Organisation) (c)<br />[hasPermission](hasPermission) (op) **some** [Permission](SecurityClearance) (c)<br />[actsAs](actsAs) (op) **some** [Role](Role) (c)<br />
...
Restrictions |[requiresSecurityClassification](requiresSecurityClassification) (op) **only** [SecurityClassification](SecurityClassification) (c)<br />[storedIn](storedIn) (op) **some** [IntellectualControlSystem](IntellectualControlSystem) (c)<br />[isAffectedBy](isAffectedBy) (op) **some** [Event](Event) (c)<br />[softwareAssignedID](softwareAssignedID) (dp) **some** [xsd:string](http://www.w3.org/2001/XMLSchema#string) (c)<br />[relatedTo](relatedTo) (op) **only** [Artefact](Artefact) (c)<br />[hasQuality](hasQuality) (op) **some** [PreservationQuality](PreservationQuality) (c)<br />[isChangedBy](isChangedBy) (op) **some** [InformationSystem](InformationSystem) (c)<br />[hasLocation](hasLocation) (op) **only** [SpatialLocation](SpatialLocation) (c)<br />
...
Restrictions |[format](format) (dp) **some** [rdfs:Literal](http://www.w3.org/2000/01/rdf-schema#Literal) (c)<br />[filename](filename) (dp) **some** [rdfs:Literal](http://www.w3.org/2000/01/rdf-schema#Literal) (c)<br />[storedIn](storedIn) (op) **some** [InformationSystem](InformationSystem) (c)<br />[filesize](filesize) (dp) **some** [xsd:long](http://www.w3.org/2001/XMLSchema#long) (c)<br />
...
Restrictions |[affects](affects) (op) **some** ([Artefact](Artefact) (c) or [Record](Record) (c))<br />[triggeredBy](triggeredBy) (op) **only** [Trigger](Trigger) (c)<br />[qualifiedAssociation](qualifiedAssociation) (op) **some** [Association](Association) (c)<br />[associatedFunction](associatedFunction) (op) **only** [Function](Function) (c)<br />[hasStatus](hasStatus) (op) **only** [Status](Status) (c)<br />[wasAssociatedWith](wasAssociatedWith) (op) **some** [Agent](Agent) (c)<br />[priorEvent](priorEvent) (op) **only** [Event](Event) (c)<br />[guidingPolicy](guidingPolicy) (op) **only** [Policy](Policy) (c)<br />
...
Sub-classes |[RecordStorageStandard](RecordStorageStandard) (c)<br />[DigitalPreservationPolicy](DigitalPreservationPolicy) (c)<br />[InformationManagementPolicy](InformationManagementPolicy) (c)<br />[RecordsAuthorityPolicy](RecordsAuthorityDisposalClassPolicy) (c)<br />[MinimumMetadataSetPolicy](MinimumMetadataSetPolicy) (c)<br />
...
Restrictions |[replaces](replaces) (op) **only** [Record](Record) (c)<br />[requiresSecurityClassification](requiresSecurityClassification) (op) **only** [SecurityClassification](SecurityClassification) (c)<br />[hasActivity](hasActivity) (op) **only** [Activity](Activity) (c)<br />[hasControl](requiresControl) (op) **only** [Control](Control) (c)<br />[hasCoverage](hasCoverage) (op) **only** [Coverage](Coverage) (c)<br />[relatedTo](relatedTo) (op) **only** [Record](Record) (c)<br />[hasDisposalClass](hasDisposalClass) (op) **exactly** 1 [DisposalClass](DisposalClass) (c)<br />[hasClassifier](hasClassifier) (op) **some** [Classifier](Classifier) (c)<br />[hasStatus](hasStatus) (op) **only** [Status](Status) (c)<br />[qualifiedAssociation](qualifiedAssociation) (op) **some** [Association](Association) (c)<br />[isAffectedBy](isAffectedBy) (op) **exactly** 1 [CreationEvent](RecordCreationEvent) (c)<br />[recordOf](recordOf) (op) **min** 1 [Artefact](Artefact) (c)<br />[hasSeries](hasSeries) (op) **only** [Series](Series) (c)<br />[associatedFunction](associatedFunction) (op) **min** 1 [Function](Function) (c)<br />[isAffectedBy](isAffectedBy) (op) **only** [Event](Event) (c)<br />[checksum](checksum) (dp) **max** 1<br />
### Record Audit Event
Property | Value
--- | ---
...
Super-classes |[Event](Event) (c)<br />
Restrictions |[hasControl](requiresControl) (op) **only** [Control](Control) (c)<br />
Sub-classes |[RecordReplacementEvent](RecordReplacementEvent) (c)<br />[RecordDecisionEvent](RecordDecisionEvent) (c)<br />[RecordSentencingEvent](RecordSentencingEvent) (c)<br />[RecordAuditEvent](RecordAuditEvent) (c)<br />[RecordDisposalEvent](RecordDisposalEvent) (c)<br />
...
Sub-classes |[Creator](Creator) (c)<br />[User](User) (c)<br />[Administrator](Administrator) (c)<br />[BusinessOwner](BusinessOwner) (c)<br />
