...
Restrictions |[hasStatus](hasStatus) (op) **only** [Status](Status) (c)<br />[guidingPolicy](guidingPolicy) (op) **only** [Policy](Policy) (c)<br />[hasLocation](hasLocation) (op) **only** [SpatialLocation](SpatialLocation) (c)<br />[requiresSecurityClassification](requiresSecurityClassification) (op) **only** [SecurityClassification](SecurityClassification) (c)<br />[qualifiedAssociation](qualifiedAssociation) (op) **some** [Association](Association) (c)<br />[associatedFunction](associatedFunction) (op) **only** [Function](Function) (c)<br />[endedAtTime](endedAtTime) (dp) **max** 1<br />[wasAssociatedWith](wasAssociatedWith) (op) **some** [Agent](Agent) (c)<br />[usedRecord](usedRecord) (op) **only** [Record](Record) (c)<br />[startedAtTime](startedAtTime) (dp) **max** 1<br />
...
Restrictions |[isAffectedBy](isAffectedBy) (op) **some** [Event](Event) (c)<br />[hasQuality](hasQuality) (op) **some** [PreservationQuality](PreservationQuality) (c)<br />[relatedTo](relatedTo) (op) **only** [Artefact](Artefact) (c)<br />[softwareAssignedID](softwareAssignedID) (dp) **some** [xsd:string](http://www.w3.org/2001/XMLSchema#string) (c)<br />[isChangedBy](isChangedBy) (op) **some** [InformationSystem](InformationSystem) (c)<br />[requiresSecurityClassification](requiresSecurityClassification) (op) **only** [SecurityClassification](SecurityClassification) (c)<br />[hasLocation](hasLocation) (op) **only** [SpatialLocation](SpatialLocation) (c)<br />[storedIn](storedIn) (op) **some** [IntellectualControlSystem](IntellectualControlSystem) (c)<br />
...
Sub-classes |[LogicalCollection](LogicalCollection) (c)<br />[PhysicalCollection](PhysicalCollection) (c)<br />
### Control
Property | Value
--- | ---
...
Restrictions |[qualifiedAssociation](qualifiedAssociation) (op) **some** [Association](Association) (c)<br />[priorEvent](priorEvent) (op) **only** [Event](Event) (c)<br />[hasStatus](hasStatus) (op) **only** [Status](Status) (c)<br />[associatedFunction](associatedFunction) (op) **only** [Function](Function) (c)<br />[guidingPolicy](guidingPolicy) (op) **only** [Policy](Policy) (c)<br />[triggeredBy](triggeredBy) (op) **only** [Trigger](Trigger) (c)<br />[affects](affects) (op) **some** ([Artefact](Artefact) (c) or [Record](Record) (c))<br />[wasAssociatedWith](wasAssociatedWith) (op) **some** [Agent](Agent) (c)<br />
Sub-classes |[CreationEvent](RecordCreationEvent) (c)<br />[RecordControlEvent](RecordControlEvent) (c)<br />[ArtefactControlEvent](ArtefactControlEvent) (c)<br />[ArtefactChangeEvent](ArtefactChangeEvent) (c)<br />
### Form Factor
Property | Value
--- | ---
...
Sub-classes |[DigitalPreservationPolicy](DigitalPreservationPolicy) (c)<br />[RecordsAuthorityPolicy](RecordsAuthorityDisposalClassPolicy) (c)<br />[InformationManagementPolicy](InformationManagementPolicy) (c)<br />[RecordStorageStandard](RecordStorageStandard) (c)<br />[MinimumMetadataSetPolicy](MinimumMetadataSetPolicy) (c)<br />
...
Restrictions |[replaces](replaces) (op) **only** [Record](Record) (c)<br />[checksum](checksum) (dp) **max** 1<br />[requiresSecurityClassification](requiresSecurityClassification) (op) **only** [SecurityClassification](SecurityClassification) (c)<br />[hasControl](requiresControl) (op) **only** [Control](Control) (c)<br />[hasActivity](hasActivity) (op) **only** [Activity](Activity) (c)<br />[hasCoverage](hasCoverage) (op) **only** [Coverage](Coverage) (c)<br />[relatedTo](relatedTo) (op) **only** [Record](Record) (c)<br />[isAffectedBy](isAffectedBy) (op) **exactly** 1 [CreationEvent](RecordCreationEvent) (c)<br />[qualifiedAssociation](qualifiedAssociation) (op) **some** [Association](Association) (c)<br />[hasClassifier](hasClassifier) (op) **some** [Classifier](Classifier) (c)<br />[associatedFunction](associatedFunction) (op) **min** 1 [Function](Function) (c)<br />[hasDisposalClass](hasDisposalClass) (op) **exactly** 1 [DisposalClass](DisposalClass) (c)<br />[hasStatus](hasStatus) (op) **only** [Status](Status) (c)<br />[isAffectedBy](isAffectedBy) (op) **only** [Event](Event) (c)<br />[hasSeries](hasSeries) (op) **only** [Series](Series) (c)<br />[recordOf](recordOf) (op) **min** 1 [Artefact](Artefact) (c)<br />
### Record Audit Event
Property | Value
--- | ---
...
Super-classes |[Event](Event) (c)<br />
Restrictions |[hasControl](requiresControl) (op) **only** [Control](Control) (c)<br />
Sub-classes |[RecordDisposalEvent](RecordDisposalEvent) (c)<br />[RecordAuditEvent](RecordAuditEvent) (c)<br />[RecordSentencingEvent](RecordSentencingEvent) (c)<br />[RecordReplacementEvent](RecordReplacementEvent) (c)<br />[RecordDecisionEvent](RecordDecisionEvent) (c)<br />
...
Super-classes |[RecordControlEvent](RecordControlEvent) (c)<br />
Sub-classes |[RecordFreezeEvent](RecordFreezeEvent) (c)<br />[RecordTransferEvent](RecordTransferEvent) (c)<br />[RecordDestructionEvent](RecordDestructionEvent) (c)<br />
### Record Freeze Event
Property | Value
--- | ---
