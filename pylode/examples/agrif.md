...
Restrictions |[associatedFunction](associatedFunction) (op) **only** [Function](Function) (c)<br />[requiresSecurityClassification](requiresSecurityClassification) (op) **only** [SecurityClassification](SecurityClassification) (c)<br />[startedAtTime](startedAtTime) (dp) **max** 1<br />[hasLocation](hasLocation) (op) **only** [SpatialLocation](SpatialLocation) (c)<br />[hasStatus](hasStatus) (op) **only** [Status](Status) (c)<br />[endedAtTime](endedAtTime) (dp) **max** 1<br />[guidingPolicy](guidingPolicy) (op) **only** [Policy](Policy) (c)<br />[wasAssociatedWith](wasAssociatedWith) (op) **some** [Agent](Agent) (c)<br />[qualifiedAssociation](qualifiedAssociation) (op) **some** [Association](Association) (c)<br />[usedRecord](usedRecord) (op) **only** [Record](Record) (c)<br />
...
Restrictions |[hasQuality](hasQuality) (op) **some** [PreservationQuality](PreservationQuality) (c)<br />[requiresSecurityClassification](requiresSecurityClassification) (op) **only** [SecurityClassification](SecurityClassification) (c)<br />[relatedTo](relatedTo) (op) **only** [Artefact](Artefact) (c)<br />[isAffectedBy](isAffectedBy) (op) **some** [Event](Event) (c)<br />[storedIn](storedIn) (op) **some** [IntellectualControlSystem](IntellectualControlSystem) (c)<br />[softwareAssignedID](softwareAssignedID) (dp) **some** [xsd:string](http://www.w3.org/2001/XMLSchema#string) (c)<br />[hasLocation](hasLocation) (op) **only** [SpatialLocation](SpatialLocation) (c)<br />[isChangedBy](isChangedBy) (op) **some** [InformationSystem](InformationSystem) (c)<br />
...
Restrictions |[priorEvent](priorEvent) (op) **only** [Event](Event) (c)<br />[affects](affects) (op) **some** ([Artefact](Artefact) (c) or [Record](Record) (c))<br />[triggeredBy](triggeredBy) (op) **only** [Trigger](Trigger) (c)<br />[associatedFunction](associatedFunction) (op) **only** [Function](Function) (c)<br />[wasAssociatedWith](wasAssociatedWith) (op) **some** [Agent](Agent) (c)<br />[hasStatus](hasStatus) (op) **only** [Status](Status) (c)<br />[guidingPolicy](guidingPolicy) (op) **only** [Policy](Policy) (c)<br />[qualifiedAssociation](qualifiedAssociation) (op) **some** [Association](Association) (c)<br />
Sub-classes |[CreationEvent](RecordCreationEvent) (c)<br />[ArtefactChangeEvent](ArtefactChangeEvent) (c)<br />[RecordControlEvent](RecordControlEvent) (c)<br />[ArtefactControlEvent](ArtefactControlEvent) (c)<br />
### Form Factor
Property | Value
--- | ---
...
Sub-classes |[DigitalPreservationPolicy](DigitalPreservationPolicy) (c)<br />[RecordStorageStandard](RecordStorageStandard) (c)<br />[MinimumMetadataSetPolicy](MinimumMetadataSetPolicy) (c)<br />[InformationManagementPolicy](InformationManagementPolicy) (c)<br />[RecordsAuthorityPolicy](RecordsAuthorityDisposalClassPolicy) (c)<br />
...
Restrictions |[relatedTo](relatedTo) (op) **only** [Record](Record) (c)<br />[replaces](replaces) (op) **only** [Record](Record) (c)<br />[hasStatus](hasStatus) (op) **only** [Status](Status) (c)<br />[hasSeries](hasSeries) (op) **only** [Series](Series) (c)<br />[isAffectedBy](isAffectedBy) (op) **only** [Event](Event) (c)<br />[isAffectedBy](isAffectedBy) (op) **exactly** 1 [CreationEvent](RecordCreationEvent) (c)<br />[qualifiedAssociation](qualifiedAssociation) (op) **some** [Association](Association) (c)<br />[hasDisposalClass](hasDisposalClass) (op) **exactly** 1 [DisposalClass](DisposalClass) (c)<br />[hasControl](requiresControl) (op) **only** [Control](Control) (c)<br />[hasActivity](hasActivity) (op) **only** [Activity](Activity) (c)<br />[hasClassifier](hasClassifier) (op) **some** [Classifier](Classifier) (c)<br />[associatedFunction](associatedFunction) (op) **min** 1 [Function](Function) (c)<br />[recordOf](recordOf) (op) **min** 1 [Artefact](Artefact) (c)<br />[checksum](checksum) (dp) **max** 1<br />[hasCoverage](hasCoverage) (op) **only** [Coverage](Coverage) (c)<br />[requiresSecurityClassification](requiresSecurityClassification) (op) **only** [SecurityClassification](SecurityClassification) (c)<br />
### Record Audit Event
Property | Value
--- | ---
...
Super-classes |[Event](Event) (c)<br />
Restrictions |[hasControl](requiresControl) (op) **only** [Control](Control) (c)<br />
Sub-classes |[RecordReplacementEvent](RecordReplacementEvent) (c)<br />[RecordSentencingEvent](RecordSentencingEvent) (c)<br />[RecordAuditEvent](RecordAuditEvent) (c)<br />[RecordDisposalEvent](RecordDisposalEvent) (c)<br />[RecordDecisionEvent](RecordDecisionEvent) (c)<br />
