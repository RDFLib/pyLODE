...
Narrower Concepts |[Physical Artefact](PhysicalArtefact) (cp)<br />[Digital Artefact](DigitalArtefact) (cp)<br />
...
Narrower Concepts |[Artefact Control Event](ArtefactControlEvent) (cp)<br />[Record Control Event](RecordControlEvent) (cp)<br />[Record Creation Event](RecordCreationEvent) (cp)<br />[Artefact Change Event](ArtefactChangeEvent) (cp)<br />
### Form Factor
Property | Value
--- | ---
...
Narrower Concepts |[Series](Series) (cp)<br />[Controlled Vocabulary](ControlledVocabulary) (cp)<br />
...
Narrower Concepts |[Digital Preservation Policy](DigitalPreservationPolicy) (cp)<br />[Information Management Policy](InformationManagementPolicy) (cp)<br />[Record Storage Standard](RecordStorageStandard) (cp)<br />[Records Authority Disposal Class Policy](RecordsAuthorityDisposalClassPolicy) (cp)<br />[Minimum Metadata Set Policy](MinimumMetadataSetPolicy) (cp)<br />
...
Broader Concepts |[Event](Event) (cp)<br />
Narrower Concepts |[Record Disposal Event](RecordDisposalEvent) (cp)<br />[Record Audit Event](RecordAuditEvent) (cp)<br />[Record Decision Event](RecordDecisionEvent) (cp)<br />[Record Sentencing Event](RecordSentencingEvent) (cp)<br />[Record Replacement Event](RecordReplacementEvent) (cp)<br />
...
Narrower Concepts |[Administrator](Administrator) (cp)<br />[Business Owner](BusinessOwner) (cp)<br />[User](User) (cp)<br />[Creator](Creator) (cp)<br />
