...
Restrictions |[usedRecord](usedRecord) (op) **only** [Record](Record) (c)<br />[qualifiedAssociation](qualifiedAssociation) (op) **some** [Association](Association) (c)<br />[hasStatus](hasStatus) (op) **only** [Status](Status) (c)<br />[endedAtTime](endedAtTime) (dp) **max** 1<br />[associatedFunction](associatedFunction) (op) **only** [Function](Function) (c)<br />[requiresSecurityClassification](requiresSecurityClassification) (op) **only** [SecurityClassification](SecurityClassification) (c)<br />[hasLocation](hasLocation) (op) **only** [SpatialLocation](SpatialLocation) (c)<br />[guidingPolicy](guidingPolicy) (op) **only** [Policy](Policy) (c)<br />[wasAssociatedWith](wasAssociatedWith) (op) **some** [Agent](Agent) (c)<br />[startedAtTime](startedAtTime) (dp) **max** 1<br />
...
Restrictions |[positionIn](positionIn) (op) **some** [Organisation](Organisation) (c)<br />[hasPermission](hasPermission) (op) **some** [Permission](Permission) (c)<br />[actsAs](actsAs) (op) **some** [Role](Role) (c)<br />
...
Restrictions |[isChangedBy](isChangedBy) (op) **some** [InformationSystem](InformationSystem) (c)<br />[hasQuality](hasQuality) (op) **some** [PreservationQuality](PreservationQuality) (c)<br />[softwareAssignedID](softwareAssignedID) (dp) **some** [xsd:string](http://www.w3.org/2001/XMLSchema#string) (c)<br />[hasLocation](hasLocation) (op) **only** [SpatialLocation](SpatialLocation) (c)<br />[relatedTo](relatedTo) (op) **only** [Artefact](Artefact) (c)<br />[isAffectedBy](isAffectedBy) (op) **some** [Event](Event) (c)<br />[requiresSecurityClassification](requiresSecurityClassification) (op) **only** [SecurityClassification](SecurityClassification) (c)<br />[storedIn](storedIn) (op) **some** [IntellectualControlSystem](IntellectualControlSystem) (c)<br />
Sub-classes |[PhysicalArtefact](PhysicalArtefact) (c)<br />[DigitalArtefact](DigitalArtefact) (c)<br />
...
Sub-classes |[JurisdictionalCoverage](JurisdictionalCoverage) (c)<br />[SpatialCoverage](SpatialCoverage) (c)<br />[TemporalCoverage](TemporalCoverage) (c)<br />
...
Restrictions |[affects](affects) (op) **some** ([Artefact](Artefact) (c) or [Record](Record) (c))<br />[guidingPolicy](guidingPolicy) (op) **only** [Policy](Policy) (c)<br />[priorEvent](priorEvent) (op) **only** [Event](Event) (c)<br />[qualifiedAssociation](qualifiedAssociation) (op) **some** [Association](Association) (c)<br />[triggeredBy](triggeredBy) (op) **only** [Trigger](Trigger) (c)<br />[hasStatus](hasStatus) (op) **only** [Status](Status) (c)<br />[associatedFunction](associatedFunction) (op) **only** [Function](Function) (c)<br />[wasAssociatedWith](wasAssociatedWith) (op) **some** [Agent](Agent) (c)<br />
Sub-classes |[ArtefactControlEvent](ArtefactControlEvent) (c)<br />[ArtefactChangeEvent](ArtefactChangeEvent) (c)<br />[RecordControlEvent](RecordControlEvent) (c)<br />[CreationEvent](RecordCreationEvent) (c)<br />
### Form Factor
Property | Value
--- | ---
...
Sub-classes |[RecordsAuthorityPolicy](RecordsAuthorityDisposalClassPolicy) (c)<br />[RecordStorageStandard](RecordStorageStandard) (c)<br />[MinimumMetadataSetPolicy](MinimumMetadataSetPolicy) (c)<br />[InformationManagementPolicy](InformationManagementPolicy) (c)<br />[DigitalPreservationPolicy](DigitalPreservationPolicy) (c)<br />
...
Restrictions |[qualifiedAssociation](qualifiedAssociation) (op) **some** [Association](Association) (c)<br />[hasCoverage](hasCoverage) (op) **only** [Coverage](Coverage) (c)<br />[isAffectedBy](isAffectedBy) (op) **exactly** 1 [CreationEvent](RecordCreationEvent) (c)<br />[hasControl](requiresControl) (op) **only** [Control](Control) (c)<br />[associatedFunction](associatedFunction) (op) **min** 1 [Function](Function) (c)<br />[recordOf](recordOf) (op) **min** 1 [Artefact](Artefact) (c)<br />[hasActivity](hasActivity) (op) **only** [Activity](Activity) (c)<br />[requiresSecurityClassification](requiresSecurityClassification) (op) **only** [SecurityClassification](SecurityClassification) (c)<br />[replaces](replaces) (op) **only** [Record](Record) (c)<br />[isAffectedBy](isAffectedBy) (op) **only** [Event](Event) (c)<br />[hasStatus](hasStatus) (op) **only** [Status](Status) (c)<br />[hasDisposalClass](hasDisposalClass) (op) **exactly** 1 [DisposalClass](DisposalClass) (c)<br />[checksum](checksum) (dp) **max** 1<br />[hasClassifier](hasClassifier) (op) **some** [Classifier](Classifier) (c)<br />[hasSeries](hasSeries) (op) **only** [Series](Series) (c)<br />[relatedTo](relatedTo) (op) **only** [Record](Record) (c)<br />
### Record Audit Event
Property | Value
--- | ---
...
Super-classes |[Event](Event) (c)<br />
Restrictions |[hasControl](requiresControl) (op) **only** [Control](Control) (c)<br />
Sub-classes |[RecordAuditEvent](RecordAuditEvent) (c)<br />[RecordReplacementEvent](RecordReplacementEvent) (c)<br />[RecordDisposalEvent](RecordDisposalEvent) (c)<br />[RecordDecisionEvent](RecordDecisionEvent) (c)<br />[RecordSentencingEvent](RecordSentencingEvent) (c)<br />
...
Super-classes |[RecordControlEvent](RecordControlEvent) (c)<br />
Sub-classes |[RecordDestructionEvent](RecordDestructionEvent) (c)<br />[RecordFreezeEvent](RecordFreezeEvent) (c)<br />[RecordTransferEvent](RecordTransferEvent) (c)<br />
### Record Freeze Event
Property | Value
--- | ---
...
Super-classes |[RecordDisposalEvent](RecordDisposalEvent) (c)<br />
Restrictions |[transferredFrom](transferredFrom) (op) **some** [Role](Role) (c)<br />[transferredTo](transferredTo) (op) **some** [Role](Role) (c)<br />[hasManifest](hasManifest) (op) **only** [Manifest](Manifest) (c)<br />
...
Restrictions |[hasPermission](hasPermission) (op) **some** [Permission](Permission) (c)<br />
Sub-classes |[Administrator](Administrator) (c)<br />[BusinessOwner](BusinessOwner) (c)<br />[User](User) (c)<br />[Creator](Creator) (c)<br />
