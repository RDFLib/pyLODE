...
Narrower Concepts |[Security Control](SecurityControl) (cp)<br />[Access Control](AccessControl) (cp)<br />
...
Narrower Concepts |[Information Management Policy](InformationManagementPolicy) (cp)<br />[Minimum Metadata Set Policy](MinimumMetadataSetPolicy) (cp)<br />[Records Authority Disposal Class Policy](RecordsAuthorityDisposalClassPolicy) (cp)<br />[Digital Preservation Policy](DigitalPreservationPolicy) (cp)<br />[Record Storage Standard](RecordStorageStandard) (cp)<br />
...
Broader Concepts |[Event](Event) (cp)<br />
Narrower Concepts |[Record Sentencing Event](RecordSentencingEvent) (cp)<br />[Record Audit Event](RecordAuditEvent) (cp)<br />[Record Replacement Event](RecordReplacementEvent) (cp)<br />[Record Disposal Event](RecordDisposalEvent) (cp)<br />[Record Decision Event](RecordDecisionEvent) (cp)<br />
...
Broader Concepts |[Record Control Event](RecordControlEvent) (cp)<br />
Narrower Concepts |[Record Destruction Event](RecordDestructionEvent) (cp)<br />[Record Freeze Event](RecordFreezeEvent) (cp)<br />[Record Transfer Event](RecordTransferEvent) (cp)<br />
### Record Freeze Event
Property | Value
--- | ---
