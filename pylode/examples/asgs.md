...
Super-classes |[asgs:Feature](ASGSFeature) (c)<br />
Restrictions |[geo:sfContains](http://www.opengis.net/ont/geosparql#sfContains) **min** 1 [asgs:MeshBlock](MeshBlock) (c)<br />[geo:sfWithin](http://www.opengis.net/ont/geosparql#sfWithin) **exactly** 1 [asgs:StatisticalAreaLevel2](StatisticalAreaLevel2) (c)<br />
### ASGS Feature
Property | Value
--- | ---
...
Sub-classes |[asgs:StatisticalAreaLevel1](StatisticalAreaLevel1) (c)<br />[asgs:SectionOfStateRange](SectionofStateRange) (c)<br />[asgs:TourismRegion](TourismRegion) (c)<br />[asgs:StateOrTerritory](StateOrTerritory) (c)<br />[asgs:IndigenousArea](IndigenousArea) (c)<br />[asgs:StatisticalAreaLevel3](StatisticalAreaLevel3) (c)<br />[asgs:AustralianDrainageDivision](AustralianDrainageDivision) (c)<br />[asgs:RemotenessArea](RemotenessArea) (c)<br />[asgs:StatisticalAreaLevel2](StatisticalAreaLevel2) (c)<br />[asgs:Country](Country) (c)<br />[asgs:NaturalResourceManagementRegion](NaturalResourceManagementRegion) (c)<br />[asgs:DestinationZone](DestinationZone) (c)<br />[asgs:CommonwealthElectoralDivision](CommonwealthElectoralDivision) (c)<br />[asgs:GreaterCapitalCityStatisticalArea](GreaterCapitalCityStatisticalArea) (c)<br />[asgs:StatisticalAreaLevel4](StatisticalAreaLevel4) (c)<br />[asgs:StateSuburb](StateSuburb) (c)<br />[asgs:StateElectoralDivision](StateElectoralDivision) (c)<br />[asgs:SignificantUrbanArea](SignificantUrbanArea) (c)<br />[asgs:PostalArea](Postalarea) (c)<br />[asgs:LocalGovernmentArea](LocalGovernmentArea) (c)<br />[asgs:IndigenousLocation](IndigenousLocation) (c)<br />[asgs:UrbanCentreAndLocality](UrbanCentreAndLocality) (c)<br />[asgs:SectionOfState](SectionofState) (c)<br />[asgs:IndigenousRegion](IndigenousRegion) (c)<br />[asgs:MeshBlock](MeshBlock) (c)<br />
...
Super-classes |[asgs:Feature](ASGSFeature) (c)<br />
Restrictions |[geo:sfWithin](http://www.opengis.net/ont/geosparql#sfWithin) **max** 1 [asgs:UrbanCentreAndLocality](UrbanCentreAndLocality) (c)<br />[geo:sfWithin](http://www.opengis.net/ont/geosparql#sfWithin) **exactly** 1 [asgs:StatisticalAreaLevel2](StatisticalAreaLevel2) (c)<br />[geo:sfWithin](http://www.opengis.net/ont/geosparql#sfWithin) **max** 1 [asgs:IndigenousLocation](IndigenousLocation) (c)<br />[geo:sfWithin](http://www.opengis.net/ont/geosparql#sfWithin) **max** 1 [asgs:RemotenessArea](RemotenessArea) (c)<br />
...
Super-classes |[asgs:Feature](ASGSFeature) (c)<br />
Restrictions |[geo:sfWithin](http://www.opengis.net/ont/geosparql#sfWithin) **exactly** 1 [asgs:StatisticalAreaLevel3](StatisticalAreaLevel3) (c)<br />[geo:sfWithin](http://www.opengis.net/ont/geosparql#sfWithin) **max** 1 [asgs:SignificantUrbanArea](SignificantUrbanArea) (c)<br />
