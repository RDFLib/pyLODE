...
Sub-classes |[asgs:StatisticalAreaLevel2](StatisticalAreaLevel2) (c)<br />[asgs:StateElectoralDivision](StateElectoralDivision) (c)<br />[asgs:StateOrTerritory](StateOrTerritory) (c)<br />[asgs:IndigenousLocation](IndigenousLocation) (c)<br />[asgs:AustralianDrainageDivision](AustralianDrainageDivision) (c)<br />[asgs:NaturalResourceManagementRegion](NaturalResourceManagementRegion) (c)<br />[asgs:StateSuburb](StateSuburb) (c)<br />[asgs:DestinationZone](DestinationZone) (c)<br />[asgs:CommonwealthElectoralDivision](CommonwealthElectoralDivision) (c)<br />[asgs:IndigenousArea](IndigenousArea) (c)<br />[asgs:TourismRegion](TourismRegion) (c)<br />[asgs:IndigenousRegion](IndigenousRegion) (c)<br />[asgs:PostalArea](Postalarea) (c)<br />[asgs:StatisticalAreaLevel4](StatisticalAreaLevel4) (c)<br />[asgs:SectionOfState](SectionofState) (c)<br />[asgs:MeshBlock](MeshBlock) (c)<br />[asgs:StatisticalAreaLevel1](StatisticalAreaLevel1) (c)<br />[asgs:SectionOfStateRange](SectionofStateRange) (c)<br />[asgs:RemotenessArea](RemotenessArea) (c)<br />[asgs:UrbanCentreAndLocality](UrbanCentreAndLocality) (c)<br />[asgs:GreaterCapitalCityStatisticalArea](GreaterCapitalCityStatisticalArea) (c)<br />[asgs:SignificantUrbanArea](SignificantUrbanArea) (c)<br />[asgs:LocalGovernmentArea](LocalGovernmentArea) (c)<br />[asgs:Country](Country) (c)<br />[asgs:StatisticalAreaLevel3](StatisticalAreaLevel3) (c)<br />
...
Super-classes |[asgs:Feature](ASGSFeature) (c)<br />
Restrictions |[geo:sfWithin](http://www.opengis.net/ont/geosparql#sfWithin) **max** 1 [asgs:GreaterCapitalCityStatisticalArea](GreaterCapitalCityStatisticalArea) (c)<br />[geo:sfWithin](http://www.opengis.net/ont/geosparql#sfWithin) **exactly** 1 [asgs:StateOrTerritory](StateOrTerritory) (c)<br />
### Tourism Region
Property | Value
--- | ---
