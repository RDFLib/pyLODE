...
In domain of |[hasGeometry](hasGeometry) (op)<br />[defaultGeometry](defaultGeometry) (op)<br />
### Geometry
Property | Value
--- | ---
...
Super-classes |[SpatialObject](SpatialObject) (c)<br />
In domain of |[dimension](dimension) (dp)<br />[isEmpty](isEmpty) (dp)<br />[asGML](asGML) (dp)<br />[isSimple](isSimple) (dp)<br />[hasSerialization](hasserialization) (dp)<br />[asWKT](asWKT) (dp)<br />[spatialDimension](spatialDimension) (dp)<br />[coordinateDimension](coordinateDimension) (dp)<br />
...
Sub-classes |[Geometry](Geometry) (c)<br />[Feature](Feature) (c)<br />
In domain of |[sfDisjoint](sfDisjoint) (op)<br />[rcc8ec](externallyconnected) (op)<br />[sfTouches](touches) (op)<br />[ehCoveredBy](coveredBy) (op)<br />[rcc8ntppi](non-tangentialproperpartinverse) (op)<br />[sfEquals](sfEquals) (op)<br />[ehMeet](meet) (op)<br />[ehInside](inside) (op)<br />[sfOverlaps](overlaps) (op)<br />[rcc8tpp](tangentialproperpart) (op)<br />[ehEquals](equals) (op)<br />[ehOverlap](overlap) (op)<br />[rcc8eq](rcc8eq) (op)<br />[rcc8ntpp](non-tangentialproperpart) (op)<br />[ehContains](contains) (op)<br />[sfContains](sfContains) (op)<br />[ehDisjoint](disjoint) (op)<br />[rcc8dc](disconnected) (op)<br />[sfIntersects](intersects) (op)<br />[sfWithin](within) (op)<br />[rcc8po](partiallyoverlapping) (op)<br />[rcc8tppi](tangentialproperpartinverse) (op)<br />[sfCrosses](crosses) (op)<br />[ehCovers](covers) (op)<br />
In range of |[rcc8dc](disconnected) (op)<br />[rcc8ec](externallyconnected) (op)<br />[rcc8tppi](tangentialproperpartinverse) (op)<br />[rcc8po](partiallyoverlapping) (op)<br />[ehMeet](meet) (op)<br />[rcc8ntppi](non-tangentialproperpartinverse) (op)<br />[sfEquals](sfEquals) (op)<br />[sfTouches](touches) (op)<br />[rcc8ntpp](non-tangentialproperpart) (op)<br />[sfIntersects](intersects) (op)<br />[rcc8tpp](tangentialproperpart) (op)<br />[ehCovers](covers) (op)<br />[ehContains](contains) (op)<br />[ehCoveredBy](coveredBy) (op)<br />[ehOverlap](overlap) (op)<br />[rcc8eq](rcc8eq) (op)<br />[sfCrosses](crosses) (op)<br />[ehEquals](equals) (op)<br />[ehInside](inside) (op)<br />[sfDisjoint](sfDisjoint) (op)<br />[ehDisjoint](disjoint) (op)<br />[sfWithin](within) (op)<br />[sfOverlaps](overlaps) (op)<br />[sfContains](sfContains) (op)<br />
