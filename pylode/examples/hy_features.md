...
In range of |[hyf:containedCatchment](containedCatchment) (op)<br />[hyf:lowerCatchment](lowerCatchment) (op)<br />[hyf:realizedCatchment](realizedCatchment) (op)<br />[hyf:conjointCatchment](conjointCatchment) (op)<br />[hyf:receivingCatchment](receivingCatchment) (op)<br />[hyf:containingCatchment](containingCatchment) (op)<br />[hyf:contributingCatchment](contributingCatchment) (op)<br />[hyf:upperCatchment](upperCatchment) (op)<br />
...
Sub-classes |[hyf:HY_CartographicRealization](HY_CartographicRealization) (c)<br />[hyf:HY_CatchmentDivide](HY_CatchmentDivide) (c)<br />[hyf:HY_CatchmentArea](HY_CatchmentArea) (c)<br />[hyf:HY_HydroNetwork](HY_HydroNetwork) (c)<br />[hyf:HY_FlowPath](HY_FlowPath) (c)<br />
...
Restrictions |[gsp:hasGeometry](http://www.opengis.net/ont/geosparql#hasGeometry) **only** [gsp:Geometry](http://www.opengis.net/ont/geosparql#Geometry) (c)<br />[hyf:realizedNexus](realizedNexus) (op) **only** [hyf:HY_HydroNexus](HY_HydroNexus) (c)<br />[hyf:referencedPosition](referencedPosition) (op) **only** [hyf:HY_IndirectPosition](HY_IndirectPosition) (c)<br />[hyf:hydroLocationType](hydroLocationType) (op) **only** [hyf:HY_HydroLocationType](HY_HydroLocationType) (c)<br />
In range of |[hyf:referenceLocation](referenceLocation) (op)<br />[hyf:locatedReferent](locatedReferent) (op)<br />[hyf:nexusRealization](nexusRealization) (op)<br />
...
Restrictions |[hyf:contributingCatchment](contributingCatchment) (op) **only** [hyf:HY_Catchment](HY_Catchment) (c)<br />[hyf:receivingCatchment](receivingCatchment) (op) **only** [hyf:HY_Catchment](HY_Catchment) (c)<br />[hyf:nexusRealization](nexusRealization) (op) **only** [hyf:HY_HydroLocation](ReferenceLocation) (c)<br />
...
Restrictions |[hyf:referenceLocation](referenceLocation) (op) **only** [hyf:HY_HydroLocation](ReferenceLocation) (c)<br />[hyf:locatedReferent](locatedReferent) (op) **only** [hyf:HY_HydroLocation](ReferenceLocation) (c)<br />[hyf:distanceExpression](distanceExpression) (op) **only** [hyf:HY_DistanceFromReferent](HY_DistanceFromReferent) (c)<br />[hyf:distanceDescription](distanceDescription) (op) **only** [hyf:HY_DistanceDescription](HY_DistanceDescription) (c)<br />[hyf:linearElement](linearElement) (op) **only** [hyf:HY_FlowPath](HY_FlowPath) (c)<br />
