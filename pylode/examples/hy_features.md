...
Restrictions |[hyf:lowerCatchment](lowerCatchment) (op) **only** [hyf:HY_Catchment](HY_Catchment) (c)<br />[hyf:conjointCatchment](conjointCatchment) (op) **only** [hyf:HY_Catchment](HY_Catchment) (c)<br />[hyf:inflow](inflow) (op) **only** [hyf:HY_HydroNexus](HY_HydroNexus) (c)<br />[hyf:catchmentRealization](catchmentRealization) (op) **only** [hyf:HY_CatchmentRealization](HY_CatchmentRealization) (c)<br />[hyf:code](code) (op) **only** [rdfs:Resource](http://www.w3.org/2000/01/rdf-schema#Resource) (c)<br />[hyf:containedCatchment](containedCatchment) (op) **only** [hyf:HY_Catchment](HY_Catchment) (c)<br />[hyf:upperCatchment](upperCatchment) (op) **only** [hyf:HY_Catchment](HY_Catchment) (c)<br />[hyf:containingCatchment](containingCatchment) (op) **only** [hyf:HY_Catchment](HY_Catchment) (c)<br />[hyf:outflow](outflow) (op) **only** [hyf:HY_HydroNexus](HY_HydroNexus) (c)<br />
Sub-classes |[hyf:HY_DendriticCatchment](HY_DendriticCatchment) (c)<br />[hyf:HY_InteriorCatchment](HY_InteriorCatchment) (c)<br />[hyf:HY_CatchmentAggregate](HY_CatchmentAggregate) (c)<br />
In range of |[hyf:lowerCatchment](lowerCatchment) (op)<br />[hyf:containedCatchment](containedCatchment) (op)<br />[hyf:receivingCatchment](receivingCatchment) (op)<br />[hyf:containingCatchment](containingCatchment) (op)<br />[hyf:conjointCatchment](conjointCatchment) (op)<br />[hyf:upperCatchment](upperCatchment) (op)<br />[hyf:contributingCatchment](contributingCatchment) (op)<br />[hyf:realizedCatchment](realizedCatchment) (op)<br />
...
Restrictions |[hyf:exorheicDrainage](exorheicDrainage) (op) **only** [hyf:HY_DendriticCatchment](HY_DendriticCatchment) (c)<br />[hyf:endorheicDrainage](endorheicDrainage) (op) **only** [hyf:HY_InteriorCatchment](HY_InteriorCatchment) (c)<br />
### HY_CatchmentArea
Property | Value
--- | ---
...
Sub-classes |[hyf:HY_CartographicRealization](HY_CartographicRealization) (c)<br />[hyf:HY_CatchmentArea](HY_CatchmentArea) (c)<br />[hyf:HY_CatchmentDivide](HY_CatchmentDivide) (c)<br />[hyf:HY_HydroNetwork](HY_HydroNetwork) (c)<br />[hyf:HY_FlowPath](HY_FlowPath) (c)<br />
...
Restrictions |[hyf:precisionStatement](precisionStatement) (dp) **only** [sc:Measure](http://shapechange.net/resources/ont/base#Measure) (c)<br />[hyf:absolute](absolute) (dp) **only** [sc:Measure](http://shapechange.net/resources/ont/base#Measure) (c)<br />[hyf:accuracyStatement](accuracyStatement) (dp) **only** [xsd:string](http://www.w3.org/2001/XMLSchema#string) (c)<br />[hyf:interpolative](interpolative) (dp) **only** [xsd:double](http://www.w3.org/2001/XMLSchema#double) (c)<br />
...
Super-classes |[hyf:HY_CatchmentRealization](HY_CatchmentRealization) (c)<br />
In range of |[hyf:linearElement](linearElement) (op)<br />[hyf:flowpath](flowpath) (op)<br />
### HY_HydroFeature
Property | Value
--- | ---
...
Restrictions |[hyf:usage](usage) (op) **only** [hyf:HY_NameUsage](HY_NameUsage) (c)<br />[hyf:preferredBy](preferredBy) (op) **only** [http://def.seegrid.csiro.au/isotc211/iso19115/2003/citationResponsibleParty](http://def.seegrid.csiro.au/isotc211/iso19115/2003/citationResponsibleParty) (c)<br />[hyf:HY_HydroFeatureName.name](HY_HydroFeatureName.name) (dp) **only** [xsd:string](http://www.w3.org/2001/XMLSchema#string) (c)<br />[hyf:namesPart](namesPart) (dp) **only** [xsd:boolean](http://www.w3.org/2001/XMLSchema#boolean) (c)<br />[hyf:variantSpelling](variantSpelling) (dp) **only** [xsd:boolean](http://www.w3.org/2001/XMLSchema#boolean) (c)<br />
...
Restrictions |[hyf:referencedPosition](referencedPosition) (op) **only** [hyf:HY_IndirectPosition](HY_IndirectPosition) (c)<br />[hyf:realizedNexus](realizedNexus) (op) **only** [hyf:HY_HydroNexus](HY_HydroNexus) (c)<br />[hyf:hydroLocationType](hydroLocationType) (op) **only** [hyf:HY_HydroLocationType](HY_HydroLocationType) (c)<br />[gsp:hasGeometry](http://www.opengis.net/ont/geosparql#hasGeometry) **only** [gsp:Geometry](http://www.opengis.net/ont/geosparql#Geometry) (c)<br />
In range of |[hyf:locatedReferent](locatedReferent) (op)<br />[hyf:nexusRealization](nexusRealization) (op)<br />[hyf:referenceLocation](referenceLocation) (op)<br />
...
Super-classes |[hyf:HY_CatchmentRealization](HY_CatchmentRealization) (c)<br />
Restrictions |[hyf:catchmentDivide](catchmentDivide) (op) **only** [hyf:HY_CatchmentDivide](HY_CatchmentDivide) (c)<br />[hyf:catchmentArea](catchmentArea) (op) **only** [hyf:HY_CatchmentArea](HY_CatchmentArea) (c)<br />[hyf:flowpath](flowpath) (op) **only** [hyf:HY_FlowPath](HY_FlowPath) (c)<br />
### HY_HydroNexus
Property | Value
--- | ---
...
Restrictions |[hyf:receivingCatchment](receivingCatchment) (op) **only** [hyf:HY_Catchment](HY_Catchment) (c)<br />[hyf:nexusRealization](nexusRealization) (op) **only** [hyf:HY_HydroLocation](ReferenceLocation) (c)<br />[hyf:contributingCatchment](contributingCatchment) (op) **only** [hyf:HY_Catchment](HY_Catchment) (c)<br />
