...
Sub-classes |[i72:Unit_multiplication](unitmultiplication) (c)<br />[i72:Unit_exponentiation](unitexponentiation) (c)<br />[i72:Unit_division](unitdivision) (c)<br />
### Dimension
Property | Value
--- | ---
...
Super-classes |[http://www.w3.org/2003/01/geo/wgs84_pos#Feature](http://www.w3.org/2003/01/geo/wgs84_pos#Feature) (c)<br />[i72:ISO21972Thing](ISO21972Thing) (c)<br />[gis:Polygon](http://http://www.opengis.net/ont/geosparql#Polygon) (c)<br />
### fixed point
Property | Value
--- | ---
...
Sub-classes |[i72:Measurement_scale_category](Measurement_scale_category) (c)<br />[i72:Measure](measure) (c)<br />[i72:Application_area](Application_area) (c)<br />[i72:Unit_of_measure](Unit_of_measure) (c)<br />[i72:Dimension](Dimension) (c)<br />[i72:Ordered_measurement_scale_category](Ordered_measurement_scale_category) (c)<br />[i72:Measurement_scale](Measurement_scale) (c)<br />[i72:Quantity](quantity) (c)<br />[i72:Binary_prefix](Binary_prefix) (c)<br />[i72:Sample](Sample) (c)<br />[i72:System_of_units](System_of_units) (c)<br />[i72:Phenomenon](Phenomenon) (c)<br />[i72:Variable](Variable) (c)<br />[i72:Prefix](Prefix) (c)<br />[i72:Indicator](Indicator) (c)<br />[i72:Singular_unit](Singular_unit) (c)<br />[i72:Vectorial_or_tensorial_character](Vectorial_or_tensorial_character) (c)<br />[i72:Parameter](Parameter) (c)<br />[i72:Monetary_unit](Monetary_unit) (c)<br />[i72:Population](Population) (c)<br />[i72:Feature](Feature) (c)<br />[i72:Point](point) (c)<br />[i72:City](City) (c)<br />[i72:Statistic](Statistic) (c)<br />[i72:Observation](Observation) (c)<br />
### Indicator
Property | Value
--- | ---
...
Super-classes |[i72:ISO21972Thing](ISO21972Thing) (c)<br />
Sub-classes |[i72:Nominal_scale](nominalscale) (c)<br />[i72:Ordinal_scale](ordinalscale) (c)<br />[i72:Cardinal_scale](cardinalscale) (c)<br />
...
Super-classes |[i72:ISO21972Thing](ISO21972Thing) (c)<br />
Restrictions |[i72:member_of](member_of) (op) **only** [i72:Population](Population) (c)<br />[i72:has_characteristic](has_characteristic) (op) **exactly** 1 [i72:Variable](Variable) (c)<br />
...
Sub-classes |[i72:Cardinality](Cardinality) (c)<br />[i72:Mean](Mean) (c)<br />[i72:Distinct_count](Distinct_count) (c)<br />[i72:Sum](Sum) (c)<br />[i72:Standard_deviation](Standard_deviation) (c)<br />
...
Super-classes |[i72:ISO21972Thing](ISO21972Thing) (c)<br />
Restrictions |[i72:for_time_interval](for_time_interval) (op) **only** [time:DateTimeInterval](http://www.w3.org/2006/time#DateTimeInterval) (c)<br />[i72:is_composed_of](is_composed_of) (op) **only** [owl:Thing](http://www.w3.org/2002/07/owl#Thing) (c)<br />[i72:definition](definition) (op) **exactly** 1 [i72:Feature](Feature) (c)<br />[i72:defined_by](defined_by) (op) **only** [owl:Thing](http://www.w3.org/2002/07/owl#Thing) (c)<br />[i72:is_described_by](is_described_by) (op) **only** [i72:Parameter](Parameter) (c)<br />
In range of |[i72:std_of](std_of) (op)<br />[i72:is_part_of](is_part_of) (op)<br />[i72:cardinality_of](cardinality_of) (op)<br />[i72:sum_of](sum_of) (op)<br />[i72:mean_of](mean_of) (op)<br />
### prefix
Property | Value
--- | ---
...
In domain of |[i72:phenomenon](phenomenon) (op)<br />[i72:value](value) (op)<br />
In range of |[i72:derived_quantity](derivedquantity) (op)<br />[i72:base_quantity](basequantity) (op)<br />
### RatioIndicator
Property | Value
--- | ---
IRI | `http://ontology.eil.utoronto.ca/ISO21972/iso21972#RatioIndicator`
Super-classes |[i72:Indicator](Indicator) (c)<br />
Restrictions |[i72:denominator](denominatot) (op) **exactly** 1 [i72:Quantity](quantity) (c)<br />[i72:numerator](numerator) (op) **exactly** 1 [i72:Quantity](quantity) (c)<br />[i72:unit_of_measure](unitofmeasure) (op) **exactly** 1 [i72:Unit_division](unitdivision) (c)<br />
### ratio scale
Property | Value
--- | ---
...
Sub-classes |[i72:Sample_mean](Sample_mean) (c)<br />[i72:Sample_cardinality](Sample_cardinality) (c)<br />[i72:Sample_standard_deviation](Sample_standard_deviation) (c)<br />[i72:Sample_sum](Sample_sum) (c)<br />
...
In range of |[i72:denominator](denominatot) (op)<br />[i72:numerator](numerator) (op)<br />[i72:base](base) (op)<br />[i72:term_1](term1) (op)<br />[i72:unit_of_measure](unitofmeasure) (op)<br />[i72:base_unit](baseunit) (op)<br />[i72:term_2](term2) (op)<br />
### Variable
Property | Value
--- | ---
