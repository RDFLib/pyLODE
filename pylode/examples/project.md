...
Restrictions |[prov:hadRole](http://www.w3.org/ns/prov#hadRole) **value** [proji:Funder](http://linked.data.gov.au/def/project/Funder) (c)<br />[prov:agent](http://www.w3.org/ns/prov#agent) **exactly** 1<br />[proj:fundsProvided](http://linked.data.gov.au/def/project#fundsProvided) (op) **min** 1<br />
