...
Restrictions |[prov:hadRole](http://www.w3.org/ns/prov#hadRole) **value** [proji:Funder](http://linked.data.gov.au/def/project/Funder) (c)<br />[proj:fundsProvided](http://linked.data.gov.au/def/project#fundsProvided) (op) **min** 1<br />[prov:agent](http://www.w3.org/ns/prov#agent) **exactly** 1<br />
...
In domain of |[proj:moneyCurrency](http://linked.data.gov.au/def/project#moneyCurrency) (op)<br />[proj:moneyAmount](http://linked.data.gov.au/def/project#moneyAmount) (dp)<br />
