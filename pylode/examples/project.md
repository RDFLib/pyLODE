...
Restrictions |[proj:fundsProvided](http://linked.data.gov.au/def/project#fundsProvided) (op) **min** 1<br />[prov:agent](http://www.w3.org/ns/prov#agent) **exactly** 1<br />[prov:hadRole](http://www.w3.org/ns/prov#hadRole) **value** [proji:Funder](http://linked.data.gov.au/def/project/Funder) (c)<br />
...
Restrictions |[proj:hadBudgetTotal](http://linked.data.gov.au/def/project#hadBudgetTotal) (op) **exactly** 1<br />[proj:hadLeader](http://linked.data.gov.au/def/project#hadLeader) (op) **min** 1<br />[proj:plannedStart](http://linked.data.gov.au/def/project#plannedStart) (dp) **exactly** 1<br />[proj:hadPlan](http://linked.data.gov.au/def/project#hadPlan) (op) **min** 1<br />[proj:hadSponsor](http://linked.data.gov.au/def/project#hadSponsor) (op) **min** 1<br />[proj:plannedEnd](http://linked.data.gov.au/def/project#plannedEnd) (dp) **exactly** 1<br />
Sub-classes |[proj:ResearchProject](http://linked.data.gov.au/def/project#ResearchProject) (c)<br />
In domain of |[proj:hadBudgetTotal](http://linked.data.gov.au/def/project#hadBudgetTotal) (op)<br />[proj:hadAreaOfInterest](http://linked.data.gov.au/def/project#hadAreaOfInterest) (op)<br />[proj:wasFundedThrough](http://linked.data.gov.au/def/project#wasFundedThrough) (op)<br />[proj:hadObjective](http://linked.data.gov.au/def/project#hadObjective) (dp)<br />[proj:hadPlan](http://linked.data.gov.au/def/project#hadPlan) (op)<br />[proj:hadSponsor](http://linked.data.gov.au/def/project#hadSponsor) (op)<br />
### Research Project
Property | Value
--- | ---
...
In domain of |[proj:hadPrincipalInvestigator](http://linked.data.gov.au/def/project#hadPrincipalInvestigator) (op)<br />[proj:hadFieldOfResearch](http://linked.data.gov.au/def/project#hadFieldOfResearch) (op)<br />
### Sum of money
Property | Value
--- | ---
...
Property | Value
--- | ---
IRI | `http://linked.data.gov.au/def/project#hadBudgetTotal`
Domain(s) |[proj:Project](http://linked.data.gov.au/def/project#Project) (c)<br />
Range(s) |[proj:SumOfMoney](http://linked.data.gov.au/def/project#SumOfMoney) (c)<br />
[](fieldofresearch)
### field of research
Property | Value
--- | ---
IRI | `http://linked.data.gov.au/def/project#hadFieldOfResearch`
...
Property | Value
--- | ---
IRI | `http://linked.data.gov.au/def/project#hadLeader`
...
Property | Value
--- | ---
IRI | `http://linked.data.gov.au/def/project#hadPlan`
...
Property | Value
--- | ---
IRI | `http://linked.data.gov.au/def/project#hadPrincipalInvestigator`
...
Property | Value
--- | ---
IRI | `http://linked.data.gov.au/def/project#hadRelatedActivity`
...
Property | Value
--- | ---
IRI | `http://linked.data.gov.au/def/project#hadSponsor`
Super-properties |[prov:wasAssociatedWith](http://www.w3.org/ns/prov#wasAssociatedWith)<br />
Domain(s) |[proj:Project](http://linked.data.gov.au/def/project#Project) (c)<br />
[](hassub-activity)
### has sub-activity
Property | Value
--- | ---
IRI | `http://linked.data.gov.au/def/project#hadSubActivity`
Domain(s) |[prov:Activity](http://www.w3.org/ns/prov#Activity) (c)<br />
...
Property | Value
--- | ---
IRI | `http://linked.data.gov.au/def/project#wasSubActivityOf`
...
Property | Value
--- | ---
IRI | `http://linked.data.gov.au/def/project#grantNumber`
Domain(s) |[proj:FundingAssociation](http://linked.data.gov.au/def/project#FundingAssociation) (c)<br />
...
Property | Value
--- | ---
IRI | `http://linked.data.gov.au/def/project#hadObjective`
Domain(s) |[proj:Project](http://linked.data.gov.au/def/project#Project) (c)<br />
[](Moneyamount)
### Money amount
Property | Value
--- | ---
IRI | `http://linked.data.gov.au/def/project#moneyAmount`
Domain(s) |[proj:SumOfMoney](http://linked.data.gov.au/def/project#SumOfMoney) (c)<br />
...
Property | Value
--- | ---
IRI | `http://linked.data.gov.au/def/project#plannedEnd`
Usage Note | Usually an xsd:date or xsd:dateTime
[](plannedstart-date|time)
### planned start-date|time
Property | Value
--- | ---
IRI | `http://linked.data.gov.au/def/project#plannedStart`
Usage Note | Usually an xsd:date or xsd:dateTime
