...
Sub-classes |[reg:FederatedRegister](http://purl.org/linked-data/registry#FederatedRegister) (c)<br />[reg:DelegatedRegister](http://purl.org/linked-data/registry#DelegatedRegister) (c)<br />[reg:NamespaceForward](http://purl.org/linked-data/registry#NamespaceForward) (c)<br />
...
In domain of |[reg:enumerationObject](http://purl.org/linked-data/registry#enumerationObject) (op)<br />[reg:enumerationSubject](http://purl.org/linked-data/registry#enumerationSubject) (op)<br />[reg:enumerationPredicate](http://purl.org/linked-data/registry#enumerationPredicate) (op)<br />
### Entity Reference
Property | Value
--- | ---
...
Restrictions |[reg:sourceGraph](http://purl.org/linked-data/registry#sourceGraph) (op) **max** 1<br />[reg:entity](http://purl.org/linked-data/registry#entity) (op) **exactly** 1<br />[reg:entityVersion](http://purl.org/linked-data/registry#entityVersion) (op) **max** 1<br />
In domain of |[reg:sourceGraph](http://purl.org/linked-data/registry#sourceGraph) (op)<br />[reg:entity](http://purl.org/linked-data/registry#entity) (op)<br />[reg:entityVersion](http://purl.org/linked-data/registry#entityVersion) (op)<br />
...
Restrictions |[void:uriLookupEndpoint](http://rdfs.org/ns/void#uriLookupEndpoint) **min** 0<br />[reg:manager](http://purl.org/linked-data/registry#manager) (op) **exactly** 1<br />[dct:modified](http://purl.org/dc/terms/modified) **max** 1<br />[reg:validationQuery](http://purl.org/linked-data/registry#validationQuery) (op) **min** 0<br />[reg:governancePolicy](http://purl.org/linked-data/registry#governancePolicy) (op) **min** 0<br />[void:openSearchDescription](http://rdfs.org/ns/void#openSearchDescription) **min** 0<br />[reg:operatingLanguage](http://purl.org/linked-data/registry#operatingLanguage) (op) **min** 0<br />[void:exampleResource](http://rdfs.org/ns/void#exampleResource) **min** 0<br />[reg:owner](http://purl.org/linked-data/registry#owner) (op) **exactly** 1<br />[rdfs:label](http://www.w3.org/2000/01/rdf-schema#label) **min** 1<br />[dct:description](http://purl.org/dc/terms/description) **min** 1<br />[reg:containedItemClass](http://purl.org/linked-data/registry#containedItemClass) (op) **min** 0<br />[void:uriSpace](http://rdfs.org/ns/void#uriSpace) **max** 1<br />[dct:license](http://purl.org/dc/terms/license) **min** 0<br />
...
In domain of |[reg:containedItemClass](http://purl.org/linked-data/registry#containedItemClass) (op)<br />[reg:owner](http://purl.org/linked-data/registry#owner) (op)<br />[reg:subregister](http://purl.org/linked-data/registry#subregister) (op)<br />[reg:release](http://purl.org/linked-data/registry#release) (op)<br />[reg:governancePolicy](http://purl.org/linked-data/registry#governancePolicy) (op)<br />[reg:operatingLanguage](http://purl.org/linked-data/registry#operatingLanguage) (op)<br />[reg:manager](http://purl.org/linked-data/registry#manager) (op)<br />[reg:validationQuery](http://purl.org/linked-data/registry#validationQuery) (op)<br />
In range of |[reg:subregister](http://purl.org/linked-data/registry#subregister) (op)<br />[reg:register](http://purl.org/linked-data/registry#register) (op)<br />
### RegisterItem
Property | Value
--- | ---
...
Restrictions |[dct:modified](http://purl.org/dc/terms/modified) **max** 1<br />[dct:dateSubmitted](http://purl.org/dc/terms/dateSubmitted) **exactly** 1<br />[reg:category](http://purl.org/linked-data/registry#category) (op) **min** 0<br />[reg:representationOf](http://purl.org/linked-data/registry#representationOf) (op) **min** 0<br />[reg:alias](http://purl.org/linked-data/registry#alias) (op) **min** 0<br />[dct:license](http://purl.org/dc/terms/license) **min** 0<br />[rdfs:label](http://www.w3.org/2000/01/rdf-schema#label) **min** 1<br />[reg:itemClass](http://purl.org/linked-data/registry#itemClass) (op) **min** 1<br />[reg:notation](http://purl.org/linked-data/registry#notation) (dp) **max** 1<br />[dct:dateAccepted](http://purl.org/dc/terms/dateAccepted) **max** 1<br />[reg:submitter](http://purl.org/linked-data/registry#submitter) (op) **exactly** 1<br />[reg:hasView](http://purl.org/linked-data/registry#hasView) **min** 0<br />[reg:predecessor](http://purl.org/linked-data/registry#predecessor) (op) **min** 0<br />[reg:definition](http://purl.org/linked-data/registry#definition) (op) **exactly** 1<br />[reg:status](http://purl.org/linked-data/registry#status) (op) **min** 1<br />[dct:description](http://purl.org/dc/terms/description) **min** 0<br />
In domain of |[reg:register](http://purl.org/linked-data/registry#register) (op)<br />[reg:successor](http://purl.org/linked-data/registry#successor) (op)<br />[reg:annotation](http://purl.org/linked-data/registry#annotation) (op)<br />[reg:definition](http://purl.org/linked-data/registry#definition) (op)<br />[reg:submitter](http://purl.org/linked-data/registry#submitter) (op)<br />[reg:representationOf](http://purl.org/linked-data/registry#representationOf) (op)<br />[reg:alias](http://purl.org/linked-data/registry#alias) (op)<br />[reg:notation](http://purl.org/linked-data/registry#notation) (dp)<br />[reg:itemClass](http://purl.org/linked-data/registry#itemClass) (op)<br />[reg:predecessor](http://purl.org/linked-data/registry#predecessor) (op)<br />[reg:status](http://purl.org/linked-data/registry#status) (op)<br />[reg:category](http://purl.org/linked-data/registry#category) (op)<br />
...
In domain of |[reg:presentation](http://purl.org/linked-data/registry#presentation) (dp)<br />[reg:priorState](http://purl.org/linked-data/registry#priorState) (dp)<br />[reg:nextState](http://purl.org/linked-data/registry#nextState) (dp)<br />
