...
def test_sdo(generate_html):
    ...
    g_expected = Graph().parse(data=sdo, format="json-ld")

    html = generate_html
    soup = BeautifulSoup(html, "html.parser")
    g_received = Graph().parse(data=str(soup.find("script").text), format="json-ld")

    assert g_received.isomorphic(g_expected)


def test_logo(generate_html):
    html = generate_html
    assert f'''<div id="pylode">
      <p>made by 
    ...
    </div>''' in html, "pyLODE logo not generated correctly"


def test_metadata(generate_html):
    html = generate_html
    assert '''<div class="section" id="metadata">
...
<p>This model starts with <a href="dct:Standard">http://dublincore.org/2012/06/14/dcterms#Standard</a> entities which can either be Base Specifications (a standard not profiling any other Standard) or Profiles (Standards which do profile others). Base Specifications or Profiles can have Resource Descriptors associated with them that defines implementing rules for the it. Resource Descriptors must indicate the role they play (to guide, to validate etc.) and the formalism they adhere to (dct:format) to allow for content negotiation. A vocabulary of Resource Roles are provided alongside this vocabulary but that list is extensible.</p></dd>
      ...
      </div>''' in html, "Metadata section not generated correctly"


def test_classes(generate_html):
    html = generate_html
    assert '''<div class="section" id="classes">
        <h2>Classes</h2>
...
<p>This definition includes what are often called "application profiles", "metadata application profiles", or "metadata profiles".</p></td>
            ...
            <tr>
              ...
              <td>
                <a href="https://www.w3.org/2017/dxwg/wiki/ProfileContext">ns2:ProfileContext</a>
              </td>
            </tr>
            <tr>
              <th>
      ...
      </div>''' in html, "Classes section not generated correctly"


def test_properties(generate_html):
    html = generate_html
    assert '''<div class="section" id="objectproperties">
        ...
        <div class="property entity" id="hasArtifact">
          ...
          <table>
            ...
            <tr>
              ...
              <td>
                <span>
                  <a href="#ResourceDescriptor">ResourceDescriptor</a>
                  <sup class="sup-c" title="OWL/RDFS Class">c</sup>
                </span>
              </td>
            </tr>
        ...
        <div class="property entity" id="conformsto">
          ...
          <table>
            ...
            <tr>
              ...
              <td>
                <a href="http://purl.org/dc/terms/">dct:</a>
              </td>
            </tr>
            <tr>
              <th>
            ...
            <tr>
              ...
              <td>
                <ul>
                  ...
                  <li>
                    <span>
                      <a href="http://purl.org/dc/terms/relation">dct:relation</a>
        ...
        <div class="property entity" id="format">
          ...
          <table>
            ...
            <tr>
              ...
              <td>
                <a href="http://purl.org/dc/terms/MediaTypeOrExtent">dct:MediaTypeOrExtent</a>
              </td>
            </tr>
          </table>
        </div>
      </div>''' in html, "Properties section not generated correctly"


def test_namespaces(generate_html):
    html = generate_html
    assert '''<div id="namespaces">
        <h2>Namespaces</h2>
        <dl>
          <dt id=":">:</dt>
          <dd>
      ...
      </div>''' in html, "Namespaces section not generated correctly"


def test_legend(generate_html):
    html = generate_html
    assert '''      <div id="legend">
        <h2>Legend</h2>
        <table class="entity">
          <tr>
            <td>
      ...
      </div>''' in html, "Legend section not generated correctly"


def test_toc(generate_html):
    html = generate_html
    assert """<div id="toc">
    ...
    </div>""" in html, "ToC logo not generated correctly"


if __name__ == "__main__":
    test_sdo(generate_html)
